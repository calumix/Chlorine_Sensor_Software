...
#if ((defined USB_DEVICE_CONFIG_CDC_CIC_EP_DISABLE) && (USB_DEVICE_CONFIG_CDC_CIC_EP_DISABLE > 0U))
#define USB_DESCRIPTOR_LENGTH_CIC_EP 0
#else
#define USB_DESCRIPTOR_LENGTH_CIC_EP USB_DESCRIPTOR_LENGTH_ENDPOINT
#endif


#define USB_TOTAL_CONFIGURATION_DESCRIPTOR_SIZE	\
		USB_DESCRIPTOR_LENGTH_CONFIGURE + USB_DESCRIPTOR_LENGTH_INTERFACE + \
							  ...
							  USB_DESCRIPTOR_LENGTH_CIC_EP + USB_DESCRIPTOR_LENGTH_INTERFACE + \
...
uint8_t g_UsbDeviceConfigurationDescriptor[] = {
	...
	USB_SHORT_GET_LOW(USB_TOTAL_CONFIGURATION_DESCRIPTOR_SIZE),
	USB_SHORT_GET_HIGH(USB_TOTAL_CONFIGURATION_DESCRIPTOR_SIZE),
    ...
    /* Configuration characteristics D7: Reserved (set to one) D6: Self-powered D5: Remote Wakeup D4...0: Reserved
       (reset to zero) */
    (USB_DESCRIPTOR_CONFIGURE_ATTRIBUTE_D7_MASK) |(1U << USB_DESCRIPTOR_CONFIGURE_ATTRIBUTE_SELF_POWERED_SHIFT),
    ...
    0x02, /* Bit 1: Whether device supports the request combination of Set_Line_Coding,
...
USB_DMA_INIT_DATA_ALIGN(USB_DATA_ALIGN_SIZE)
uint8_t g_UsbDeviceString0[] = {2U + 2U, USB_DESCRIPTOR_TYPE_STRING, 0x09, 0x04};	//Language ID (english)
...
USB_DMA_INIT_DATA_ALIGN(USB_DATA_ALIGN_SIZE)
uint8_t g_UsbDeviceString2[] = {2U + 2U * 12U, USB_DESCRIPTOR_TYPE_STRING,
                                'C',           0,
                                'a',           0,
                                'l',           0,
                                'u',           0,
...
USB_DMA_INIT_DATA_ALIGN(USB_DATA_ALIGN_SIZE)
uint8_t g_UsbDeviceString3[] = {2U + 2U * 7U, USB_DESCRIPTOR_TYPE_STRING,
                                'U',           0,
                                'S',           0,
                                'B',           0,
                                '-',           0,
